...
module.exports = {
  ...
  extractErrorInformation: function extractErrorInformation(transaction, error, config) {
    let name = 'Unknown'
    let message = ''
    let type = 'Error'
  ...
  shouldIgnoreError: function shouldIgnoreError(transaction, error, config) {
    ...
    const errorInfo = this.extractErrorInformation(transaction, error, config, null)
